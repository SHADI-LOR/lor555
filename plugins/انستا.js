...
const handler = async (m, {conn, args, command, usedPrefix}) => {
  if (!args[0]) throw `*[⛩️] ارسل رابط المقطع الذي تريد تحميله من الانستغرام, مثال: ${usedPrefix + command}* https://www.instagram.com/reel/CzJ323DIwjt/?igshid=MXViZ2IyN2NnOGZtOA==`;
  m.reply(global.wait);
  try {
      ...
      try {
        ...
        try {
          ...
          try {
            ...
            throw `*[❗] حدث خطأ اثناء التحميل ربما المقطع غير صالح*`;
          }
        }
      }
    }
...
handler.command = /^(instagramdl|انستا|igdl|ig|instagramdl2|instagram2|igdl2|ig2|instagramdl3|instagram3|igdl3|ig3)$/i;
