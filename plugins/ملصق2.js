...
const handler = async (m, {conn, args, usedPrefix, command}) => {
  ...
  try {
    ...
    if (/webp|image|video/g.test(mime)) {
      ...
      if (!img) throw `*سوي رد على صورة أو فيديو عشان تحوله ستيكر\n*- مثال : ${usedPrefix + command}*`;
      let out;
      try {
      ...
      else return m.reply('*اذا تبي تحول رابط صورة ستيكر استخدم الأمر التالي : ${usedPrefix}s https://telegra.ph/file/0dc687c6165e98de2.jpg*');
    }
  } catch (e) {
    console.error(e);
    if (!stiker) stiker = e;
    ...
    else throw '*سوي رد على صورة أو فيديو ما عشان نحوله ل ملصق ❗*';
  }
};
handler.help = ['sfull'];
