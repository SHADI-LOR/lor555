...
const handler = async (m, {conn, text, usedPrefix, command}) => {
  ...
  if (!text) throw `*[🗣️] أصبحت بوتات فينوم و سوكونا يدعمو شات جي بي تي*\n\n*—◉ ادخل نص مثل ليتم الرد عليك بمقطع صوتي*\n*◉ ${usedPrefix + command} من مختارع الذكاء الاصطناعي*\n*◉ ${usedPrefix + command} كم انسان في العالم*`;
  try {
...
handler.command = /^(openaivoz|chatgptvoz|iavoz|robotvoz|openai2voz|تحدث|ia2voz|robot2voz|Mysticvoz|MysticBotvoz|gptvoz|ai_voz|ai_voce)$/i;
handler.limit = 4;
