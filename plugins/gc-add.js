...
if (!global.db.data.settings[conn.user.jid].restrict) throw '〄│ تـــم تــعــطــيــل الــامــر بــواســطــه الــمــطــور'
if (!args[0]) throw '〄│ حــط الـرقــم الــي انــت عــاوز تــضــيـفـه '    
try {    
...
let teks = `〄│ تـــم ارســـال الـــدعـــوه @${jid.split('@')[0]}`
...
throw '〄│ تــاكــد مــن صـــحـــه الـامـر واعــد الــمــحــاولــه'
}}
