...
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: '😻 𝗦𝘂𝗽𝗲𝗿 TOUKA-MD - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 ', thumbnailUrl: await(await fetch(img5)).buffer(), sourceUrl: yt }}}
...
handler.command = /^(سرعة|السرعه|velocidad|rapidez|velocity)$/i
