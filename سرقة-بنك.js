...
if (!who) throw `[⚡]⌯ مـــنـــشــن لــلي هــتــســرقــه يــالــحــرامـي`
if (!(who in global.db.data.users)) throw `[⚡]⌯ الـــمــســتــخــدم غــيــر مــــســـجــل`
